...
# 	python ~/Documents/GitHub/CorsaiR/Python/parse_Q_rates.py -q_dir ../Results/RJMCMC/genus/$pth/Q_SHIFTS/ -bin_dir ..Z/Data/time_bins/geological_stages.txt -out ../Results/RJMCMC/genus/$pth/Q_SHIFTS/Parsed_Q_rates.txt
# done