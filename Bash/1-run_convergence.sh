...
#python ~/Documents/GitHub/CorsaiR/Python/assess_run_convergence.py -dir ../Results/RJMCMC/species/1-Full_extant_extended/pyrate_mcmc_logs
#Rscript ~/Documents/GitHub/CorsaiR/R/plot_ess.r ../Results/RJMCMC/species/1-Full_extant_extended/pyrate_mcmc_logs/ESS_summary.txt ../Results/RJMCMC/species/1-Full_extant_extended/pyrate_mcmc_logs/ESS_plot.png
