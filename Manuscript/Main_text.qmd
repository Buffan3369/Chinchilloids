...
² Consejo Nacional de Investigaciones Científicas y Técnicas (CONICET), Godoy Cruz 2290, CP 1425 Ciudad Autónoma de Buenos Aires, Argentina.\
³ Grupo de Paleontología de Vertebrados, Instituto de Ecorregiones Andinas (INECOA), CONICET – Universidad Nacional de Jujuy. Av. Bolivia 1661, CP 4600 San Salvador de Jujuy, Argentina\
\^4 Instituto de Geología y Minería (IdGyM), Universidad Nacional de Jujuy. Av. Bolivia 1661, CP 4600 San Salvador de Jujuy, Argentina
...
It should be noted that the overall speciation rate value is conserved across methods (@fig-diversification A, C, E).

On the other hand, we found compelling evidence for extinction rate variation, both across time (@fig-diversification B, D, F) and lineages (@fig-extinctionBDNN, Table S5). A single significant extinction rate shift is captured by the rjMCMC model *ca*. 6.5 Ma (@fig-diversification B, Figure S2 B), coinciding with the onset of the aforementioned diversity decline. This peak in extinction rate is both detected by the BDNN and the MBD models. It should be mentioned that the intensity of this peak was more marked before we incorporate the new systematic revision of the hyperdiverse Late Miocene dinomyid fauna from the Ituzaingó formation (Entre Ríos, Argentina) made by @rasia2026, significantly reducing the number of species of the group short before the proposed time of decline of the group.

Both the MBD and the BDNN model capture a Middle Miocene increase in extinction rate, that is not retrieved from the rjMCMC model.
...
'Mesopotamiense' fauna [@candela2005; @candela2013-] is mostly made of singletons. Large endemism, as discussed by @candela2013, but our extinction rate inflation pattern greatly relies on it (**Figure SX**)
