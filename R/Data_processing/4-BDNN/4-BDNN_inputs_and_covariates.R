...
write.table.lucas(chinchi_WithTraits, 
                  "./Data/PyRate_inputs/Species/Chinchilloidea_cleaned_WithTraits_EXTENDED_EXTANT.txt")
extract.ages("./Data/PyRate_inputs/Species/Chinchilloidea_cleaned_WithTraits_EXTENDED_EXTANT.txt", 
             replicates = 20)
