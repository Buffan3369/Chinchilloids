...
empi_pred_path <- "./Results/DeepDive/species/species_models/simulation_species_ET_20251217_lstm128_64_32_d64_32_conditional"
...
dd_div <- dd_pred_plot(dd_pred_tbl = dd_pred_table,
                       ...
                       y_breaks = seq(0, max(dd_pred_table$maj_M), 20),
                       lwd = 0.5,
                       display_gts = TRUE,
                       plot.border = FALSE,
                       several_gts = TRUE,
...
ggsave("./Figures/Supp/diversity/Diversity_through_time_former_data.pdf",
       plot = Q_plot, height = 150, width = 150, units = "mm")
ggsave("./Figures/Supp/diversity/Diversity_through_time_former_data.png",
